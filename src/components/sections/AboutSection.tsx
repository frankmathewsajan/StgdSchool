...
const AboutSection = () => {
  const stats = [
    ...
    { number: "50+", label: "Faculty", icon: BookOpen },
    { number: "35+", label: "Years", icon: Award },
    { number: "100%", label: "Success", icon: Heart },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Since 1985, St. G. D. Convent School has been a beacon of educational excellence, 
            nurturing young minds and building tomorrow's leaders through innovative teaching and holistic development.
          </p>
        </div>
