  ...
  return <section className="py-16 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {leaders?.map(leader => <Card key={leader.id} className="hover:shadow-xl transition-shadow duration-300 overflow-hidden">
              <div className="relative">
                <img src={leader.image_url || "https://images.unsplash.com/photo-1494790108755-2616b612b47c?auto=format&fit=crop&w=400&h=400"} alt={leader.name} className="w-full h-64 object-cover" />
              ...
              <CardContent className="p-6">
                ...
                {leader.qualifications && <div className="mb-4">
                ...
                <div className="space-y-2 border-t pt-4">
                  {leader.email && <div className="flex items-center space-x-2 text-sm">
                      <Mail className="h-4 w-4 text-[#7d0a0a]" />
                      <a href={`mailto:${leader.email}`} className="text-gray-600 hover:text-[#7d0a0a] transition-colors">
                        {leader.email}
                      </a>
                    </div>}
                  {leader.phone && <div className="flex items-center space-x-2 text-sm">
